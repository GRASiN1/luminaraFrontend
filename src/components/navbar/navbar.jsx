      ...
      <nav className="w-full h-16 bg-white flex flex-row justify-between items-center border-b-yellow-300 border-b-2 fixed top-0 z-10">
        ...
        <div id="profileSection" className="w-1/3 h-full">
          {user ? (
            <div className="flex justify-center items-center w-full h-full">
              <div className="flex justify-center items-center w-min flex-row">
                <svg
                  ...
                  width="25px"
                  fill="#000000"
                  className="cursor-pointer mx-7 hover:fill-yellow-500"
                >
            ...
            <div className="flex justify-center items-center w-full h-full">
              <button
                className="text-center bg-black text-white px-2 py-1 rounded-md hover:bg-yellow-300 hover:text-black"
                onClick={() => {
                  toggleModal();
                }}
              >
