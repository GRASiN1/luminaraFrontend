    ...
    <>
      <nav className="w-full h-16 bg-white flex flex-row justify-between items-center border-b-pink-300 border-b-2 fixed top-0 z-10">
        ...
        >
          <div
            id="searchBox"
            className="w-3/4 rounded-md flex flex-row justify-center p-1 bg-gray-300"
          >
            <span>
              <svg
            ...
            <input
              ...
              name="search"
              id="search"
              className="w-full outline-none text-center bg-transparent text-salmonPink"
        ...
        <div id="profileSection" className="w-1/3 h-full">
          {user ? (
            <div className="flex justify-center items-center w-full h-full">
              <div className="flex justify-center items-center w-min flex-row">
                <svg
                  ...
                  width="25px"
                  fill="#000000"
                  className="cursor-pointer mx-7 hover:fill-salmonPink"
                >
                  <path d="M288.83-72q-29.35 0-50.09-20.91Q218-113.81 218-143.17q0-29.35 20.91-50.09Q259.81-214 289.17-214q29.35 0 50.09 20.91Q360-172.19 360-142.83q0 29.35-20.91 50.09Q318.19-72 288.83-72Zm397.42 0q-29.78 0-50.01-20.91Q616-113.81 616-143.17q0-29.35 20.64-50.09Q657.27-214 686.25-214q30.28 0 50.51 20.91Q757-172.19 757-142.83q0 29.35-20.49 50.09Q716.03-72 686.25-72ZM254-730l94 195h284l106-195H254Zm-40-79h554.35q34.41 0 53.53 32Q841-745 824-712L708.07-502.33q-12.13 20.43-31.3 33.88Q657.59-455 632.86-455H338l-50 96h480v79H279q-49 0-70-33t1-73l62-112-146-311H44v-79h133l37 79Zm134 274h284-284Z" />
                </svg>
            ...
            <div className="flex justify-center items-center w-full h-full">
              <button
                className="text-center bg-black text-white px-2 py-1 rounded-md hover:bg-salmonPink hover:text-black font-bold"
                onClick={() => {
                  toggleModal();
                }}
              >
